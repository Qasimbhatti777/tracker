...
<main>
    <div class="container-fluid px-4">
      ...
      <div>
        <div>
          <h1 class="fs-5 fw-bold mb-3">Article 1 - DEFINITIONS:</h1>
          <p>
            <b> a)</b> APPLICABLE WEBSITE: This Privacy Policy will refer
            to and be applicable to the Website listed above, which shall
            hereinafter be referred to as "Website." Any listed Website
            may also refer to a corresponding mobile application, should
          ...
          <p>
            ...
            following data controller: myDocketBot, LLC. ("Data
            Controller") and you, as the user of this Website.
            Hereinafter, the parties will individually be referred to as
            "Party" and collectively as "Parties."
          </p>
          <p>
            <b>d) DATA CONTROLLER:</b> Data Controller is the publisher,
            owner, and operator of the Website and is the Party
          ...
          <p>
            ...
            continue your use of the Website, you will be referred to
          ...
          <p>
            ...
            your use of the Website that is capable of identifying you in
            any manner.
          </p>
        </div>
        <div>
          <h1 class="fs-5 fw-bold mb-3">
          ...
          <p>
            ...
            it, then you agree to immediately cease your use of our
            website.
          </p>
        </div>
        <div>
          <h1 class="fs-5 fw-bold mb-3">Article 3 - CONTACT:</h1>
          <p>
            The Party responsible for the processing of your personal data
            is as follows:
          </p>
          <p>
            myDocketBot, LLC. The Data Controller may be contacted as
            follows:
          </p>
          <div class="ms-5">
            <p>data@mydocketbot.com</p>
            <p>PO BOX 123456</p>
            <p>Los Angeles, CA</p>
          </div>
          <p>
            The Data Controller and operator of the Website are one and
            the same.
          </p>
        </div>
        <div>
          <h1 class="fs-5 fw-bold mb-3">Article 4 - LOCATION:</h1>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            different types of Personal Data collected and different
            manners of collection:
          </p>
          <p>
            <b>a) Registered users: </b>You, as a user of the Website, may
            be asked to register in order to use the Website or to
            purchase the Services available for sale.
          </p>
          <p>
            During the process of your registration, we will collect some
            of the following Personal Data from you through your voluntary
            disclosure:
          </p>
          <p class="ms-5">
            Name, Email Address, Business Name, Billing Information.
          </p>
          ...
          <div class="ms-5">
            ...
            <p>IV) receiving general emails from us</p>
            <p>V) Or the following other forms of participation:</p>
            <p class="ms-5">
              Users can enter court case numbers of cases they wish to
          ...
          <p>
            ...
            the Website and do not register for any purchases or other
            service, you may still be subject to certain passive data
            collection ("Passive Data Collection"). Such Passive Data
            Collection may include through cookies, as described below, IP
            address information, location information, and certain browser
            data, such as history and/or session information.
          </p>
          <p>
            <b>c) All users:</b> The Passive Data Collection that applies
            to Unregistered users shall also apply to all other users
            and/or visitors of our Website.
          </p>

          <p>
            <b>d) Sales & Billing Information:</b> In order to purchase
            any of the services on the Website, you will be asked to
            ...
            payment and billing information will not be stored and will be
            used exclusively to assist with your one-time purchase.
          </p>

          <p>
            <b>e) Email Marketing:</b> You may be asked to provide certain
            Personal Data, such as your name and email address, for the
            purpose of receiving email marketing communications. This
            information will only be obtained through your voluntary
            disclosure and you will be asked to affirmatively opt-in to
            email marketing communications.
          </p>

          <p>
            <b>f) User Experience:</b> From time to time, we may request
            information from you to assist us in improving our website,
            and the Services we sell, such as demographic information or
            your particular preferences.
          </p>

          <p>
            <b>g) Combined or Aggregated Information:</b> We may combine
            or aggregate some of your Personal Data in order to better
            serve you and to better enhance and update our website for
        ...
        <div>
          ...
          <div>
            <p>
              ...
              browsing preferences) as well as through information that
              you volunteer to us (such as information that you provide
              during a registration process or at other times while using
            ...
            <p>
              ...
              used to store some information that may concern the user,
              his or her preferences, or the device they are using to
              access the internet (such as a computer, tablet, or mobile
              phone). Cookies are mainly used to adapt the operation of
              the site to your expectations, offering a more personalized
              browsing experience and memorizing the choices you made
              previously.
            </p>
            ...
            <p>
              ...
              not be able to use our Website as we intend. To proceed
          ...
          <div class="ms-5">
            <p>
              <b>Technical cookies:</b> Technical cookies, which can also
              sometimes be called HTML cookies, are used for navigation
              and to facilitate your access to and use of the site. They
              are necessary for the transmission of communications on the
              network or to supply services requested by you. The use of
              technical cookies allows the safe and efficient use of the
              site.
            </p>

            <p>
              You can manage or request the general deactivation or
              cancellation of cookies through your browser. If you do this
              though, please be advised this action might slow down or
              prevent access to some parts of the site.
            </p>
            ...
            <p>
              ...
              also considered technical cookies when they operate as
              described.
            </p>
            ...
            <p>
              <b>Third-party cookies:</b> We may also utilize third-party
              cookies, which are cookies sent by a third-party to your
              computer. Permanent cookies are often third-party cookies.
              The majority of third-party cookies consist of tracking
            ...
            <p>
              ...
              parties external to the site. Third-party analytical cookies
              are used to detect information on user behavior on our
              Website. This takes place anonymously, in order to monitor
              the performance and improve the usability of the site.
              Third-party profiling cookies are used to create profiles
              relating to users, in order to propose advertising in line
              with the choices expressed by the users themselves.
            </p>

            <p>
              <b>Profiling cookies:</b> We may also use profiling cookies,
              which are those that create profiles related to the user and
              are used in order to send advertising to the user's browser.
              When these types of cookies are used, we will receive your
              explicit consent.
            </p>

            <p>
              <b>Support in configuring your browser:</b> You can manage
            ...
            <div class="ms-5">
              ...
              <p>
                - Type of browser and device parameters used to connect to
                the Website;
              </p>
              <p>- Name of the Internet Service Provider (ISP);</p>
              <p>- Date and time of visit;</p>
              <p>- Web page of origin of the user (referral) and exit;</p>
              <p>- Possibly the number of clicks.</p>
            </div>
          </div>
          <p>
        ...
        <div>
          <h1 class="fs-5 fw-bold mb-3">Article 8 - THIRD PARTIES:</h1>
          <div>
            <p>
            ...
            <div class="ms-5">
              ...
              <p>
                ...
                Service Providers in order to help us track usage data,
                such as referral websites, dates and times of page
                requests, etc. We use this information to understand
                patterns of usage of, and to improve, the Website.
              </p>
              <p>
                We may use Third-Party Service Providers to host the
                Website. In this instance, the Third-Party Service
                Provider will have access to your Personal Data.
              </p>
              <p>
                Your Personal Data will not be sold or otherwise
                transferred to other third parties without your approval.
              </p>
              <p>
                Notwithstanding the other provisions of this Privacy
                Policy, we may provide your Personal Data to a third party
                or to third parties in order to protect the rights,
                property or safety, of us, our customers or third parties,
              ...
              <p>
                If your Personal Data might be provided to a third party
                in a manner that is other than as explained in this
                Privacy Policy, you will be notified. You will also have
                the opportunity to request that we not share that
                information.
              </p>
              <p>
        ...
        <div>
          ...
          <div>
            <p>
              ...
              Data is protected against unauthorized access, disclosure,
              or destruction.
            </p>
            <p>
              ...
              very seriously. We take all reasonable steps to protect your
              Personal Data.
            </p>
            <p>
              Personal Data is stored throughout your relationship with
              us. We delete your Personal Data upon request for
              cancelation of your account or other general request for the
              deletion of data.
            </p>
            <p>
        ...
        <div>
          ...
          <div>
            <p>
              ...
              better experience for you on our website and to provide you
              the services and/or information you may have requested, such
              as use of our website.
            </p>
            <p>
            ...
            <div class="ms-5">
              ...
              <p>d) Fulfilling your purchases</p>
              <p>e) Providing customer service to you</p>
              <p>
                f) Advising you about updates to the Website or related
                Items
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div>
            ...
            <div class="ms-5">
              ...
              <p>
                f) If we suspect any fraudulent activity on our website or
                if we have noticed any activity which may violate our
        ...
        <div>
          ...
          <div>
            <p>
              ...
              marketing communications related to our website such as
              announcements or other information. If you wish to opt-out
              of such communications, you may contact the following email:
              optout@mydocketbot.com. You may also click the opt-out link
            ...
            <p>
              ...
              that is specifically about your use of our website or about
              your account with us.
            </p>
            <p>
              By providing any Personal Data to us, or by using our
              website in any manner, you have created a commercial
        ...
        <div>
          <h1 class="fs-5 fw-bold mb-3">
            Article 13 - MODIFYING, DELETING, AND ACCESSING YOUR
            INFORMATION:
          </h1>
          <p>
        ...
        <div>
          ...
          <p>
            By continuing to our website in any manner, use the Product,
        ...
        <div>
          <h1 class="fs-5 fw-bold mb-3">Article 15 - YOUR RIGHTS:</h1>
          <p>
          ...
          <div class="ms-5">
            ...
            <p>
              - the right to oppose or limit the processing of your
              Personal Data
            </p>
            <p>
              - the right to request that we stop processing and delete
              your Personal Data
            </p>
            <p>
              - the right to block any Personal Data processing in
        ...
        <div>
          ...
          <p>
            ...
            customerservice@mydocketbot.com.
          </p>
        </div>
      </div>
    </div>
