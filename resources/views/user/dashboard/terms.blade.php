...
<main>
    <div class="container-fluid px-4">
      ...
      <p>
        ...
        Conditions (hereinafter the "Agreement"), all parts and sub-parts
        of which are specifically incorporated by reference here. This
      ...
      <p>
        ...
        billing information You provide us, including credit card, billing
        ...
        identifying information. Providing false or inaccurate
      ...
      <p>
        ...
        those Services. These monetary amounts ("Fees") will be described
        to You during Your account registration and/or confirmation
        process. The final amount required for payment will be shown to
        You immediately prior to purchase. Payment for any on-going
        Services is billed automatically until You notify Us that You
        would like to terminate Your access to the Services.
      </p>
      ...
      <p>
        <strong
          >a) You further agree not to use the Website or
          Services:</strong
        >
      </p>
      <p>
      ...
      <div class="ms-5">
        ...
        <p>
          ...
          following number of days: 90. After that time, it will be
          deleted.
        </p>
      </div>
      ...
      <p>
        ...
        requesting termination. Please keep in mind that any outstanding
        fees will still be due even after termination of Your account. At
      ...
      <p>
        <b>b) JURISDICTION, VENUE &amp; CHOICE OF LAW:</b> Through Your
        use of the Website or Services, You agree that the laws of the
        State of California shall govern any matter or dispute relating to
        or arising out of this Agreement, as well as any dispute of any
        ...
        county: Los Angeles, California. The Parties agree that this
      ...
      <p>
        ...
        submit the dispute to binding arbitration. The arbitration shall
        be conducted in the following county: Los Angeles. The arbitration
        shall be conducted by a single arbitrator, and such arbitrator
        shall have no authority to add Parties, vary the provisions of
        this Agreement, award punitive damages, or certify a class. The
        arbitrator shall be bound by applicable and governing Federal law
        as well as the law of the following state: California. Each Party
        shall pay their own costs and fees. Claims necessitating
        ...
        regulations. Intellectual property claims by the Company will not
        be subject to arbitration and may, as an exception to this
      ...
      <p>
        <b>e) SEVERABILITY:</b> If any part or sub-part of this Agreement
      ...
      <p>
        ...
        including e-mail or fax. For any questions or concerns, please
        email Us at the following address: info@mycourtbot.com.
      </p>
    </div>
  </main>
@endsection
